...
export class EndScene extends Phaser.Scene{
    ...
    create(){
        ...
        console.log(gameScene.karma);
				...
				if(gameScene.karma >= 0 && gameScene.karma < 33 && gameScene.playerHealth > 0){
            console.log("worst");
        ...
        if(gameScene.karma >= 33 && gameScene.karma < 100 && gameScene.playerHealth > 0){
            console.log("medium");
        ...
        if(gameScene.karma == 100 && gameScene.playerHealth > 0){
            console.log("best");
