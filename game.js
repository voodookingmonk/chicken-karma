...
let WorldScene = new Phaser.Class({
    ...
    create: function ()
    {
        ...
        this.physics.add.overlap(this.npcEnemy, this.NPC, this.onMeetNPC, false, this);
        this.physics.add.overlap(this.npcEnemy, this.NPC2, this.onMeetNPC, false, this);
        this.physics.add.overlap(this.npcEnemy, this.NPC3, this.onMeetNPC, false, this);
        this.physics.add.overlap(this.npcEnemy, this.test, this.onMeetNPC, false, this);
